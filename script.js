document.addEventListener('DOMContentLoaded', () => {
    ...
    viewBtn.addEventListener('click', function() {
        ...
        try {
            ...
            if (base64String.startsWith('data:application/pdf;base64,')) {
                cleanBase64 = base64String.replace('data:application/pdf;base64,', '');
            }
    ...
    sampleBtn.addEventListener('click', function() {
        base64Input.value = SAMPLE_BASE_64;
        viewBtn.click();
    });
    
    // PDF to Base64 functionality
    convertBtn.addEventListener('click', function() {
        ...
        if (file.type !== 'application/pdf') {
            pdfErrorMsg.textContent = 'Please select a valid PDF file';
            return;
        }
        ...
        reader.onerror = function() {
            pdfErrorMsg.textContent = 'Error reading the file';
        };
